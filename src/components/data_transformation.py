...
class DataTransformation:
    ...
    def get_data_tranformer_object(self):
        "This function responisible for data transformation"
        try:
            ...
            logging.info(f"numerical column standerd scaling completed:{numerical_column}")
            logging.info(f"catgeorical column encoding completed:{categorical_columns}")
